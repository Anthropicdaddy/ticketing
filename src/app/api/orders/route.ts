...
<div style="padding:12px 0;border-bottom:1px solid #f0efe9;font-size:14px;display:flex;justify-content:space-between"><span style="color:#6b6b7b">メール</span><span style="font-weight:600">${email}</span></div>
